...
/**
 * Walk up from this file looking for a `dist/<filename>` directory.
 * Used by the SessionStart default resolver to land on the package root
 * in both dev (packages/cli) and bundled (node_modules/teamagent) layouts.
 */
